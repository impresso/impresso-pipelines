...
- **Ad Classification Pipeline**: Identifies advertisements in historical newspaper content using a fine-tuned XLM-RoBERTa model with rule-based features.
...
pip install "impresso-pipelines[oneclassadclassifier]" # Ad Classification
...
- [Ad Classification Pipeline](README_oneclassadclassifier.md)
